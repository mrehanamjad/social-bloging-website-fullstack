...
function Button({
    ...
    return (
        <button className={`px-4 py-2 rounded active:scale-95 shadow-lg hover:shadow-none  ${varient === 'blue' ? "bg-blue-600 text-white hover:bg-blue-700": "bg-slate-200 hover:bg-slate-300"}    ${className}`} {...props}>
            {children}
        </button>
    )
}
