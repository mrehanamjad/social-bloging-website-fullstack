  ...
  const submit = async (data) => {
    ...
    try {
      ...
      if (error.message.toLowerCase().includes("id already exists")) {
        ...
        setBackendError(
          "Post content characters limit exceeded. Please shorten your content."
        );
      } else if (
        error.message.toLowerCase().includes("missing required attribute")
      ) {
        setBackendError("Please fill in all required fields.");
      } else if (
        error.message.toLowerCase().includes("invalid type for attribute")
      ) {
